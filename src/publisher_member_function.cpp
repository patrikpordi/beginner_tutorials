...
class MinimalPublisher : public rclcpp::Node {
 ...
 private:
  ...
  void change_string_callback(
      const std::shared_ptr<cpp_pubsub::srv::ChangeString::Request>
          request,
      std::shared_ptr<cpp_pubsub::srv::ChangeString::Response>
          response) {
